    ...
    <div class="add-table-box" :class="[show1 ? 'edit' : 'read']">
      ...
      <table class="box_table">
        ...
        <tr>
          ...
          <td class="t2"><el-form-item prop="name"><el-input  v-model="ruleForm.name" placeholder="请输入您的姓名"  maxlength="30" :disabled="!show1"></el-input></el-form-item></td>
          <td class="t1"><em class="red">*</em>身份证号码</td>
          <td class="t2"><el-form-item prop="idCard"><el-input class="auth-input" placeholder="请输入身份证号" v-model.trim="ruleForm.idCard" maxlength="18" :disabled="!show1"></el-input></el-form-item></td>
        </tr>
        <tr>
    ...
    <div class="add-table-box">
      ...
      <div v-for="(item, index) in ruleForm.educationParams" :key="item.key">
        <table class="box_table" >
          ...
          <tr>
            <td class="t1">学校</td>
            <td class="t2"><el-form-item class="rules"  :prop="'educationParams.' + index +'.university'" :rules="formRules.university"><el-input  placeholder="请输入学校"  maxlength="30" :disabled="!show3" v-model="item.university"></el-input></el-form-item></td>
            <td class="t1">学历/培训证书</td>
            <td class="t2"> <el-form-item class="rules"  :prop="'educationParams.'+ index +'.degree'" :rules="formRules.degree"><el-input   placeholder="请选择"  maxlength="11" :disabled="!show3" v-model="item.degree"></el-input></el-form-item></td>
          </tr>
          <tr>
            <td class="t1">专业</td>
            <td class="t2"> <el-form-item class="rules"  :prop="'educationParams.'+ index +'.major'" :rules="formRules.major"><el-input   placeholder="请输入专业"  maxlength="30" :disabled="!show3" v-model="item.major"></el-input></el-form-item></td>
            <td class="t1">入学时间</td>
            <td class="t2">
              <el-form-item class="rules"  :prop="'educationParams.'+ index +'.startTime'" :rules="formRules.startTime">
                <el-date-picker
                  :disabled="!show3"
        ...
        <div class="delete-bar">
          <el-button type="danger" @click="deleteBtn(item, index, 'edu')"  v-show="showDelete.edu && index !== 0 " class="el-icon-delete">&nbsp;删除</el-button>
        </div>
      </div>
    </div>
    <div class="add-table-box">
      ...
      <div v-for="(item, index) in ruleForm.workParams" :key="item.key">
        <table class="box_table" >
          ...
          <tr>
            <td class="t1">入职时间</td>
            <td class="t2">
              <el-form-item class="rules"  :prop="'workParams.'+ index +'.startTime'" :rules="formRules.startTime">
                <el-date-picker
                  :disabled="!show4"
                  value-format="yyyy-MM"
                  v-model="item.startTime"
            ...
            <td class="t1">离职时间</td>
            <td class="t2">
              <el-form-item class="rules"  :prop="'workParams.'+ index +'.endTime'" :rules="formRules.endTime">
                <el-date-picker
                  :disabled="!show4"
                  value-format="yyyy-MM"
                  v-model="item.endTime"
        ...
        <div class="delete-bar">
          <el-button type="danger" @click="deleteBtn(item, index, 'work')" v-show="showDelete.work && index !== 0 " class="el-icon-delete">&nbsp;删除</el-button>
        </div>
      </div>
    </div>
    </el-form>
  ...
  export default {
    ...
    data() {
      ...
      return {
        ...
        ruleForm: {
          ...
          'maritalStatus': null,
          'currentAddress': null,
          'educationParams': [{ university: '', degree: '', major: '', startTime: '', endTime: '', certificateNum: '' }],
          'workParams': [{ company: '', position: '', startTime: '', endTime: '', reason: '', witness: '', witnessMobile: '', relation: '' }]
        },
    ...
    methods: {
      ...
      addItems(type) {
        switch (type) {
          case 'edu' :
            this.ruleForm.educationParams.push({ university: '', degree: '', major: '', startTime: '', endTime: '' })
            this.showDelete[type] = true
            this.addNum.edu++
            console.log(this.addNum.edu)
            break
          case 'work' :
            this.ruleForm.workParams.push({ company: '', startTime: '', endTime: '', salary: '', witness: '', witnessMobile: '' })
            this.showDelete[type] = true
            this.addNum.work++
      ...
      submitSendForm() {
        ...
        if (!this.ruleForm.name) {
          this.$message.error('候选人姓名不能为空')
          return false
        }
        if (!this.ruleForm.idCard) {
          this.$message.error('候选人身份证号码不能为空')
          return false
        }
        if (!this.ruleForm.mobile) {
          this.$message.error('候选人手机号码不能为空')
          return false
        }
